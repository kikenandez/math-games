(function () {
  ...
  const map = {
    fr: {
      ...
      "Tank": "Tank",
      "Smooth": "Fluide",
      "blast the rocks that solve the equation": "explosez les rochers qui résolvent l'équation",
      "1 · TARGET": "1 · CIBLEZ",
      "3 · BLAST": "3 · EXPLOSEZ",
      "An equation shows at the top. Solve it in your head.": "Une équation s'affiche en haut. Résolvez-la de tête.",
      "Find the asteroid carrying that answer.": "Trouvez l'astéroïde qui porte cette réponse.",
      "Shoot it. Wrong rocks cost you — aim sharp.": "Tirez dessus. Les mauvais rochers coûtent cher — visez juste.",
      "Thrust with <b>↑</b>, rotate with <b>← →</b>, fire with <b>Space</b>. Wrong rocks <b>split and multiply</b>, so only shoot the right answer. Clear them to advance.": "Propulsez avec <b>↑</b>, tournez avec <b>← →</b>, tirez avec <b>Espace</b>. Les mauvais rochers <b>se divisent et se multiplient</b>, alors ne tirez que sur la bonne réponse. Éliminez-les pour avancer.",
      "Keys — <kbd>↑</kbd> thrust · <kbd>← →</kbd> rotate · <kbd>Space</kbd> fire · <kbd>P</kbd> pause": "Touches — <kbd>↑</kbd> propulser · <kbd>← →</kbd> tourner · <kbd>Space</kbd> tirer · <kbd>P</kbd> pause",
      "Lines": "Lignes",
      "Target": "Objectif",
      "CHILL": "COOL",
      "Palette": "Palette",
      ...
      "stack the blocks · hit the target sum": "empilez les blocs · atteignez la somme cible",
      "1 · DROP": "1 · LÂCHEZ",
      "2 · SUM": "2 · ADDITIONNEZ",
      "Numbered blocks fall. Move and rotate to place them.": "Des blocs numérotés tombent. Déplacez et tournez pour les placer.",
      "Fill a row so its numbers add up to the target.": "Remplissez une rangée pour que ses nombres atteignent la cible.",
      "Matching rows vanish for points. Wrong sums stay.": "Les rangées correctes disparaissent et rapportent des points. Les mauvaises sommes restent.",
      "✦ CLEAR": "✦ EFFACER",
      "Rows only clear when they're <b>full</b> and the numbers <b>sum to the target</b>. Plan placements so each line lands on the goal — overshoot and the row sticks around.": "Les rangées ne s'effacent que lorsqu'elles sont <b>pleines</b> et que les nombres <b>atteignent la cible</b>. Planifiez vos placements pour que chaque ligne tombe pile — dépassez et la rangée reste.",
      "Keys — <kbd>← →</kbd> move · <kbd>↑</kbd> rotate · <kbd>↓</kbd> soft drop · <kbd>Space</kbd> hard drop · <kbd>P</kbd> pause": "Touches — <kbd>← →</kbd> déplacer · <kbd>↑</kbd> tourner · <kbd>↓</kbd> chute douce · <kbd>Space</kbd> chute rapide · <kbd>P</kbd> pause"
    },
    es: {
      ...
      "Tank": "Tanque",
      "Smooth": "Suave",
      "blast the rocks that solve the equation": "destruye las rocas que resuelven la ecuación",
      "1 · TARGET": "1 · APUNTA",
      "3 · BLAST": "3 · DESTRUYE",
      "An equation shows at the top. Solve it in your head.": "Aparece una ecuación arriba. Resuélvela mentalmente.",
      "Find the asteroid carrying that answer.": "Encuentra el asteroide que lleva esa respuesta.",
      "Shoot it. Wrong rocks cost you — aim sharp.": "Dispárale. Las rocas erróneas cuestan caro — apunta bien.",
      "Thrust with <b>↑</b>, rotate with <b>← →</b>, fire with <b>Space</b>. Wrong rocks <b>split and multiply</b>, so only shoot the right answer. Clear them to advance.": "Impúlsate con <b>↑</b>, gira con <b>← →</b>, dispara con <b>Espacio</b>. Las rocas erróneas <b>se dividen y multiplican</b>, así que dispara solo a la respuesta correcta. Elimínalas para avanzar.",
      "Keys — <kbd>↑</kbd> thrust · <kbd>← →</kbd> rotate · <kbd>Space</kbd> fire · <kbd>P</kbd> pause": "Teclas — <kbd>↑</kbd> impulsar · <kbd>← →</kbd> girar · <kbd>Space</kbd> disparar · <kbd>P</kbd> pausa",
      "Lines": "Líneas",
      "Target": "Objetivo",
      "CHILL": "RELAX",
      "Palette": "Paleta",
      ...
      "stack the blocks · hit the target sum": "apila los bloques · alcanza la suma objetivo",
      "1 · DROP": "1 · SUELTA",
      "2 · SUM": "2 · SUMA",
      "Numbered blocks fall. Move and rotate to place them.": "Caen bloques numerados. Mueve y gira para colocarlos.",
      "Fill a row so its numbers add up to the target.": "Llena una fila para que sus números sumen el objetivo.",
      "Matching rows vanish for points. Wrong sums stay.": "Las filas correctas desaparecen y dan puntos. Las sumas erróneas se quedan.",
      "✦ CLEAR": "✦ LIMPIA",
      "Rows only clear when they're <b>full</b> and the numbers <b>sum to the target</b>. Plan placements so each line lands on the goal — overshoot and the row sticks around.": "Las filas solo se eliminan cuando están <b>llenas</b> y los números <b>suman el objetivo</b>. Planifica las colocaciones para que cada línea caiga justa — si te pasas, la fila se queda.",
      "Keys — <kbd>← →</kbd> move · <kbd>↑</kbd> rotate · <kbd>↓</kbd> soft drop · <kbd>Space</kbd> hard drop · <kbd>P</kbd> pause": "Teclas — <kbd>← →</kbd> mover · <kbd>↑</kbd> girar · <kbd>↓</kbd> caída suave · <kbd>Space</kbd> caída rápida · <kbd>P</kbd> pausa"
    }
  };
