(function () {
  ...
  const map = {
    fr: {
      ...
      // Balance Scale — redesigned chrome
      "Light": "Lumière",
      "NIGHT": "NUIT",
      "Jump to level": "Aller au niveau",
      "Show balance verdict": "Afficher le verdict d'équilibre",
      "Auto-advance after solve": "Avancer automatiquement après résolution",
      "visual algebra — deduce what each fruit is worth": "algèbre visuelle — déduisez la valeur de chaque fruit",
      "1 · WEIGH": "1 · PESEZ",
      "2 · DEDUCE": "2 · DÉDUISEZ",
      "3 · SOLVE": "3 · RÉSOLVEZ",
      "Every scale balances: the fruit equal the number.": "Chaque balance s'équilibre : les fruits égalent le nombre.",
      "Reason across clues to pin down each single fruit.": "Raisonnez à travers les indices pour cerner chaque fruit.",
      "Fill in every value, then hit Check.": "Remplissez chaque valeur, puis appuyez sur Vérifier.",
      "Values reshuffle each level, so it's deduction — not memory. Stuck? Tap <b>💡 Hint</b> for a nudge, or <b>New Puzzle</b> for fresh numbers.": "Les valeurs changent à chaque niveau : c'est de la déduction, pas de la mémoire. Bloqué ? Touchez <b>💡 Indice</b> pour un coup de pouce, ou <b>Nouveau puzzle</b> pour de nouveaux nombres.",
      "Keys — <kbd>click</kbd> pick a box · <kbd>Tab</kbd> next · <kbd>0–9</kbd> type · <kbd>↵</kbd> check · <kbd>H</kbd> hint · <kbd>N</kbd> new · <kbd>R</kbd> reset": "Touches — <kbd>clic</kbd> choisir une case · <kbd>Tab</kbd> suivante · <kbd>0–9</kbd> saisir · <kbd>↵</kbd> vérifier · <kbd>H</kbd> indice · <kbd>N</kbd> nouveau · <kbd>R</kbd> réinitialiser",
      // Numberfall — redesigned chrome
      "Open settings panel": "Ouvrir le panneau des réglages",
      "ANSWER": "RÉPONSE",
      "Time of day": "Moment de la journée",
      "Truck color": "Couleur du camion",
      "Scroll speed": "Vitesse de défilement",
      "Gravity": "Gravité",
      "Launch power": "Puissance de lancement",
      "Allow negative answers": "Autoriser les réponses négatives",
      "cargo edition · mental-math reflexes": "édition cargo · réflexes de calcul mental",
      "1 · WATCH": "1 · OBSERVEZ",
      "2 · SOLVE": "2 · RÉSOLVEZ",
      "3 · POP": "3 · ÉCLATEZ",
      "Boxes launch off the truck, each stamped with a sum.": "Des caisses sont lancées du camion, chacune marquée d'un calcul.",
      "Type the answer into the keypad display.": "Saisissez la réponse sur l'afficheur du clavier.",
      "Enter clears every box with that value. Combo for bonus!": "Entrée efface toutes les caisses de cette valeur. Enchaînez pour un bonus !",
      ...
      "Math": "Maths",
      "Tiles": "Tuiles",
      // Math Invaders — redesigned chrome
      "Deep space": "Espace profond",
      "VOID": "VIDE",
      "NEBULA": "NÉBULEUSE",
      "AURORA": "AURORE",
      "Formation speed": "Vitesse de formation",
      "UFO frequency": "Fréquence d'OVNI",
      "Background motion": "Mouvement du fond",
      "Anti-spam speed penalty": "Pénalité de vitesse anti-spam",
      "defend Planet Numero from the operation-ships": "défendez la planète Numéro contre les vaisseaux-opérations",
      "3 · FIRE": "3 · TIREZ",
      "A formation of math ships drifts down toward you.": "Une formation de vaisseaux mathématiques descend vers vous.",
      "Type the answer to a ship on the keypad.": "Saisissez la réponse d'un vaisseau sur le clavier.",
      "Enter vaporizes every ship sharing that value.": "Entrée vaporise tous les vaisseaux ayant cette valeur.",
      "type a number · <kbd>↵</kbd> fire · <kbd>P</kbd> pause": "saisissez un nombre · <kbd>↵</kbd> tirer · <kbd>P</kbd> pause",
      "Type an answer · press <b>Enter</b> to vaporize matching ships!": "Saisissez une réponse · appuyez sur <b>Entrée</b> pour vaporiser les vaisseaux correspondants !",
      "Clear the formation before it lands. Watch for the <b>UFO mothership</b> — worth <b>500 points</b>, but it only streaks by for a moment. Operations &amp; speed ramp up in <b>⚙ Settings</b>.": "Éliminez la formation avant qu'elle n'atterrisse. Guettez le <b>vaisseau-mère OVNI</b> — qui vaut <b>500 points</b>, mais il ne file qu'un instant. Les opérations &amp; la vitesse augmentent dans <b>⚙ Réglages</b>.",
      "Keys — <kbd>0–9</kbd> type · <kbd>−</kbd> negative · <kbd>⌫</kbd> delete · <kbd>↵</kbd> fire · <kbd>P</kbd> pause": "Touches — <kbd>0–9</kbd> saisir · <kbd>−</kbd> négatif · <kbd>⌫</kbd> effacer · <kbd>↵</kbd> tirer · <kbd>P</kbd> pause",
      // Math Whack-a-Mole — redesigned chrome
      "bonk only the moles that fit the rule": "tapez seulement les taupes qui suivent la règle",
      "2 · WHACK": "2 · TAPEZ",
      "3 · SPARE": "3 · ÉPARGNEZ",
      "A rule sets the target: evens, primes, multiples.": "Une règle fixe la cible : pairs, premiers, multiples.",
      "Click moles whose number matches before they duck.": "Cliquez les taupes dont le nombre correspond avant qu'elles plongent.",
      "Leave the wrong ones — a bad bonk costs a miss.": "Laissez les mauvaises — un mauvais coup coûte un raté.",
      "EVENS": "PAIRS",
      "Letting a <b>correct</b> mole escape also burns a miss. Three misses or the timer hitting zero ends the round — survive the clock to level up into a new rule.": "Laisser s'échapper une <b>bonne</b> taupe coûte aussi un raté. Trois ratés ou la fin du chrono terminent la manche — tenez jusqu'au bout pour passer à une nouvelle règle.",
      "Click / tap to whack · <kbd>P</kbd> pause": "Cliquez / touchez pour taper · <kbd>P</kbd> pause",
      // Missile Command — redesigned chrome
      "Cities": "Villes",
      "Sky palette": "Palette du ciel",
      "Ammo per silo": "Munitions par silo",
      "shield the cities from the meteor swarm": "protégez les villes de l'essaim de météores",
      "1 · AIM": "1 · VISEZ",
      "2 · INTERCEPT": "2 · INTERCEPTEZ",
      "3 · DEFEND": "3 · DÉFENDEZ",
      "Move your cursor over an incoming meteor.": "Placez votre curseur sur un météore qui arrive.",
      "Click — a missile arcs up and blasts at that spot.": "Cliquez — un missile s'élève et explose à cet endroit.",
      "Keep your 6 cities alive. Chain blasts score big.": "Gardez vos 6 villes en vie. Les explosions en chaîne rapportent gros.",
      "Each silo holds limited ammo and reloads between waves — watch for <b>MIRVs</b> that split midair. Lose all 6 cities and it's over.": "Chaque silo a des munitions limitées et se recharge entre les vagues — méfiez-vous des <b>MIRV</b> qui se divisent en plein vol. Perdez vos 6 villes et c'est fini.",
      "Keys — <kbd>click</kbd> launch · <kbd>A</kbd>/<kbd>S</kbd>/<kbd>D</kbd> pick silo · <kbd>P</kbd> pause": "Touches — <kbd>clic</kbd> lancer · <kbd>A</kbd>/<kbd>S</kbd>/<kbd>D</kbd> choisir le silo · <kbd>P</kbd> pause",
      // Math Asteroids + Mathris — redesigned chrome
      "in field": "en jeu",
      "Nebula": "Nébuleuse",
      "Aim": "Visée",
      "Asteroid speed": "Vitesse des astéroïdes",
      "Ops pool": "Opérations",
      "BLUE": "BLEU",
      "gun down only the rocks that hit the target": "abattez seulement les rochers qui atteignent la cible",
      "1 · LOCK": "1 · CIBLEZ",
      "2 · BLAST": "2 · EXPLOSEZ",
      "3 · SURVIVE": "3 · SURVIVEZ",
      "The HUD shows a target answer each round.": "Le tableau de bord affiche une réponse cible à chaque manche.",
      "Shoot only rocks whose math equals the target.": "Ne tirez que sur les rochers dont le calcul égale la cible.",
      "Wrong shots & timeouts drain shield → then a life.": "Les mauvais tirs & les délais épuisent le bouclier → puis une vie.",
      "Watch for <b style=\"color:#ffd24d\">★ bonus</b> rocks and <b style=\"color:#ff5c7c\">overloaded</b> chains — defuse them for big points. Drift, rotate, and use <b>hyperspace</b> to escape a tight squeeze.": "Guettez les rochers <b style=\"color:#ffd24d\">★ bonus</b> et les chaînes <b style=\"color:#ff5c7c\">surchargées</b> — désamorcez-les pour de gros points. Dérivez, tournez et utilisez l'<b>hyperespace</b> pour vous tirer d'un mauvais pas.",
      "Keys — <kbd>↑</kbd> thrust · <kbd>←→</kbd> rotate · <kbd>Space</kbd> fire · <kbd>↓</kbd> hyperspace · <kbd>P</kbd> pause": "Touches — <kbd>↑</kbd> propulser · <kbd>←→</kbd> tourner · <kbd>Space</kbd> tirer · <kbd>↓</kbd> hyperespace · <kbd>P</kbd> pause",
      "<span class=\"kbd\">↑</span> thrust &nbsp; <span class=\"kbd\">←</span><span class=\"kbd\">→</span> rotate &nbsp; <span class=\"kbd\">SPACE</span> fire &nbsp; <span class=\"kbd\">↓</span> hyperspace": "<span class=\"kbd\">↑</span> propulser &nbsp; <span class=\"kbd\">←</span><span class=\"kbd\">→</span> tourner &nbsp; <span class=\"kbd\">SPACE</span> tirer &nbsp; <span class=\"kbd\">↓</span> hyperespace",
      "click matching boxes · type to defuse": "cliquez les boîtes correspondantes · tapez pour désamorcer",
      "ANSWER · DEFUSE / MOTHERSHIP": "RÉPONSE · DÉSAMORCER / VAISSEAU-MÈRE",
      "type · <kbd>↵</kbd> submit · <kbd>P</kbd> pause": "tapez · <kbd>↵</kbd> valider · <kbd>P</kbd> pause",
      "Fall speed": "Vitesse de chute",
      "Rule rotation": "Rotation des règles",
      "Mothership frequency": "Fréquence du vaisseau-mère",
      "SLATE": "ARDOISE",
      "RUST": "ROUILLE",
      "clear-the-clutter math arcade": "arcade mathématique de nettoyage",
      "1 · SORT": "1 · TRIEZ",
      "2 · CLICK": "2 · CLIQUEZ",
      "3 · DEFUSE": "3 · DÉSAMORCEZ",
      "A rule banner says which falling boxes to clear.": "Une bannière de règle indique quelles boîtes tombantes éliminer.",
      "Click every box that matches the active rule.": "Cliquez chaque boîte qui respecte la règle active.",
      "Chains arm a bomb — type its answer to defuse it.": "Les chaînes arment une bombe — tapez sa réponse pour la désamorcer.",
      "Boxes that touch <b>merge</b> into longer chains; a 6-operand chain arms a 10-second bomb and freezes the field. Defuse for <b style=\"color:#5cd97a\">+200</b>, or let it blow for a penalty. Score starts at <b>200</b> — hit 0 and you're out.": "Les boîtes qui se touchent <b>fusionnent</b> en chaînes plus longues ; une chaîne de 6 opérandes arme une bombe de 10 secondes et gèle le terrain. Désamorcez pour <b style=\"color:#5cd97a\">+200</b>, ou laissez-la exploser pour une pénalité. Le score commence à <b>200</b> — tombez à 0 et c'est fini.",
      "Keys — <kbd>click</kbd> destroy · <kbd>0–9</kbd> type · <kbd>↵</kbd> submit · <kbd>⌫</kbd> delete · <kbd>P</kbd> pause": "Touches — <kbd>clic</kbd> détruire · <kbd>0–9</kbd> saisir · <kbd>↵</kbd> valider · <kbd>⌫</kbd> effacer · <kbd>P</kbd> pause"
    },
    es: {
      ...
      "Light": "Luz",
      "NIGHT": "NOCHE",
      "Jump to level": "Ir al nivel",
      "Show balance verdict": "Mostrar el veredicto de equilibrio",
      "Auto-advance after solve": "Avanzar automáticamente al resolver",
      "visual algebra — deduce what each fruit is worth": "álgebra visual — deduce cuánto vale cada fruta",
      "1 · WEIGH": "1 · PESA",
      "2 · DEDUCE": "2 · DEDUCE",
      "3 · SOLVE": "3 · RESUELVE",
      "Every scale balances: the fruit equal the number.": "Cada balanza se equilibra: las frutas igualan al número.",
      "Reason across clues to pin down each single fruit.": "Razona entre las pistas para fijar cada fruta.",
      "Fill in every value, then hit Check.": "Rellena cada valor y pulsa Comprobar.",
      "Values reshuffle each level, so it's deduction — not memory. Stuck? Tap <b>💡 Hint</b> for a nudge, or <b>New Puzzle</b> for fresh numbers.": "Los valores cambian en cada nivel: es deducción, no memoria. ¿Atascado? Toca <b>💡 Pista</b> para una ayuda, o <b>Nuevo puzzle</b> para números nuevos.",
      "Keys — <kbd>click</kbd> pick a box · <kbd>Tab</kbd> next · <kbd>0–9</kbd> type · <kbd>↵</kbd> check · <kbd>H</kbd> hint · <kbd>N</kbd> new · <kbd>R</kbd> reset": "Teclas — <kbd>clic</kbd> elegir casilla · <kbd>Tab</kbd> siguiente · <kbd>0–9</kbd> escribir · <kbd>↵</kbd> comprobar · <kbd>H</kbd> pista · <kbd>N</kbd> nuevo · <kbd>R</kbd> reiniciar",
      // Numberfall — redesigned chrome
      "Open settings panel": "Abrir el panel de ajustes",
      "ANSWER": "RESPUESTA",
      "Time of day": "Hora del día",
      "Truck color": "Color del camión",
      "Scroll speed": "Velocidad de desplazamiento",
      "Gravity": "Gravedad",
      "Launch power": "Potencia de lanzamiento",
      "Allow negative answers": "Permitir respuestas negativas",
      "cargo edition · mental-math reflexes": "edición carga · reflejos de cálculo mental",
      "1 · WATCH": "1 · MIRA",
      "2 · SOLVE": "2 · RESUELVE",
      "3 · POP": "3 · REVIENTA",
      "Boxes launch off the truck, each stamped with a sum.": "Las cajas salen del camión, cada una marcada con una operación.",
      "Type the answer into the keypad display.": "Escribe la respuesta en la pantalla del teclado.",
      "Enter clears every box with that value. Combo for bonus!": "Enter elimina todas las cajas con ese valor. ¡Combo para bonus!",
      ...
      "NEBULA": "NEBULOSA",
      "AURORA": "AURORA",
      "Formation speed": "Velocidad de formación",
      "UFO frequency": "Frecuencia de ovnis",
      "Background motion": "Movimiento del fondo",
      "Anti-spam speed penalty": "Penalización de velocidad anti-spam",
      "defend Planet Numero from the operation-ships": "defiende el planeta Número de las naves-operación",
      "3 · FIRE": "3 · DISPARA",
      "A formation of math ships drifts down toward you.": "Una formación de naves matemáticas desciende hacia ti.",
      "Type the answer to a ship on the keypad.": "Escribe la respuesta de una nave en el teclado.",
      "Enter vaporizes every ship sharing that value.": "Enter vaporiza todas las naves con ese valor.",
      "type a number · <kbd>↵</kbd> fire · <kbd>P</kbd> pause": "escribe un número · <kbd>↵</kbd> disparar · <kbd>P</kbd> pausa",
      "Type an answer · press <b>Enter</b> to vaporize matching ships!": "¡Escribe una respuesta · pulsa <b>Enter</b> para vaporizar las naves coincidentes!",
      "Clear the formation before it lands. Watch for the <b>UFO mothership</b> — worth <b>500 points</b>, but it only streaks by for a moment. Operations &amp; speed ramp up in <b>⚙ Settings</b>.": "Elimina la formación antes de que aterrice. Vigila la <b>nave nodriza OVNI</b> — vale <b>500 puntos</b>, pero solo pasa un instante. Las operaciones &amp; la velocidad aumentan en <b>⚙ Ajustes</b>.",
      "Keys — <kbd>0–9</kbd> type · <kbd>−</kbd> negative · <kbd>⌫</kbd> delete · <kbd>↵</kbd> fire · <kbd>P</kbd> pause": "Teclas — <kbd>0–9</kbd> escribir · <kbd>−</kbd> negativo · <kbd>⌫</kbd> borrar · <kbd>↵</kbd> disparar · <kbd>P</kbd> pausa",
      // Math Whack-a-Mole — redesigned chrome
      "bonk only the moles that fit the rule": "golpea solo los topos que cumplen la regla",
      "2 · WHACK": "2 · GOLPEA",
      "3 · SPARE": "3 · PERDONA",
      "A rule sets the target: evens, primes, multiples.": "Una regla fija el objetivo: pares, primos, múltiplos.",
      "Click moles whose number matches before they duck.": "Haz clic en los topos cuyo número coincide antes de que se escondan.",
      "Leave the wrong ones — a bad bonk costs a miss.": "Deja los incorrectos — un golpe erróneo cuesta un fallo.",
      "EVENS": "PARES",
      "Letting a <b>correct</b> mole escape also burns a miss. Three misses or the timer hitting zero ends the round — survive the clock to level up into a new rule.": "Dejar escapar un topo <b>correcto</b> también cuesta un fallo. Tres fallos o que el tiempo llegue a cero terminan la ronda — aguanta el reloj para subir a una regla nueva.",
      "Click / tap to whack · <kbd>P</kbd> pause": "Haz clic / toca para golpear · <kbd>P</kbd> pausa",
      // Missile Command — redesigned chrome
      "Cities": "Ciudades",
      "Sky palette": "Paleta del cielo",
      "Ammo per silo": "Munición por silo",
      "shield the cities from the meteor swarm": "protege las ciudades del enjambre de meteoros",
      "1 · AIM": "1 · APUNTA",
      "2 · INTERCEPT": "2 · INTERCEPTA",
      "3 · DEFEND": "3 · DEFIENDE",
      "Move your cursor over an incoming meteor.": "Mueve el cursor sobre un meteoro entrante.",
      "Click — a missile arcs up and blasts at that spot.": "Haz clic — un misil sube y estalla en ese punto.",
      "Keep your 6 cities alive. Chain blasts score big.": "Mantén vivas tus 6 ciudades. Las explosiones en cadena puntúan mucho.",
      "Each silo holds limited ammo and reloads between waves — watch for <b>MIRVs</b> that split midair. Lose all 6 cities and it's over.": "Cada silo tiene munición limitada y recarga entre oleadas — cuidado con los <b>MIRV</b> que se dividen en el aire. Pierde las 6 ciudades y se acabó.",
      "Keys — <kbd>click</kbd> launch · <kbd>A</kbd>/<kbd>S</kbd>/<kbd>D</kbd> pick silo · <kbd>P</kbd> pause": "Teclas — <kbd>clic</kbd> lanzar · <kbd>A</kbd>/<kbd>S</kbd>/<kbd>D</kbd> elegir silo · <kbd>P</kbd> pausa",
      // Math Asteroids + Mathris — redesigned chrome
      "in field": "en juego",
      "Nebula": "Nebulosa",
      "Aim": "Puntería",
      "Asteroid speed": "Velocidad de asteroides",
      "Ops pool": "Operaciones",
      "BLUE": "AZUL",
      "gun down only the rocks that hit the target": "derriba solo las rocas que dan en el objetivo",
      "1 · LOCK": "1 · FIJA",
      "2 · BLAST": "2 · DESTRUYE",
      "3 · SURVIVE": "3 · SOBREVIVE",
      "The HUD shows a target answer each round.": "El panel muestra una respuesta objetivo en cada ronda.",
      "Shoot only rocks whose math equals the target.": "Dispara solo a las rocas cuyo cálculo iguala el objetivo.",
      "Wrong shots & timeouts drain shield → then a life.": "Los disparos erróneos & los tiempos agotados vacían el escudo → luego una vida.",
      "Watch for <b style=\"color:#ffd24d\">★ bonus</b> rocks and <b style=\"color:#ff5c7c\">overloaded</b> chains — defuse them for big points. Drift, rotate, and use <b>hyperspace</b> to escape a tight squeeze.": "Vigila las rocas <b style=\"color:#ffd24d\">★ bonus</b> y las cadenas <b style=\"color:#ff5c7c\">sobrecargadas</b> — desactívalas para muchos puntos. Deriva, gira y usa el <b>hiperespacio</b> para escapar de un aprieto.",
      "Keys — <kbd>↑</kbd> thrust · <kbd>←→</kbd> rotate · <kbd>Space</kbd> fire · <kbd>↓</kbd> hyperspace · <kbd>P</kbd> pause": "Teclas — <kbd>↑</kbd> impulsar · <kbd>←→</kbd> girar · <kbd>Space</kbd> disparar · <kbd>↓</kbd> hiperespacio · <kbd>P</kbd> pausa",
      "<span class=\"kbd\">↑</span> thrust &nbsp; <span class=\"kbd\">←</span><span class=\"kbd\">→</span> rotate &nbsp; <span class=\"kbd\">SPACE</span> fire &nbsp; <span class=\"kbd\">↓</span> hyperspace": "<span class=\"kbd\">↑</span> impulsar &nbsp; <span class=\"kbd\">←</span><span class=\"kbd\">→</span> girar &nbsp; <span class=\"kbd\">SPACE</span> disparar &nbsp; <span class=\"kbd\">↓</span> hiperespacio",
      "click matching boxes · type to defuse": "haz clic en las cajas que coinciden · escribe para desactivar",
      "ANSWER · DEFUSE / MOTHERSHIP": "RESPUESTA · DESACTIVAR / NAVE NODRIZA",
      "type · <kbd>↵</kbd> submit · <kbd>P</kbd> pause": "escribe · <kbd>↵</kbd> enviar · <kbd>P</kbd> pausa",
      "Fall speed": "Velocidad de caída",
      "Rule rotation": "Rotación de reglas",
      "Mothership frequency": "Frecuencia de nave nodriza",
      "SLATE": "PIZARRA",
      "RUST": "ÓXIDO",
      "clear-the-clutter math arcade": "arcade matemático de limpieza",
      "1 · SORT": "1 · CLASIFICA",
      "2 · CLICK": "2 · CLICA",
      "3 · DEFUSE": "3 · DESACTIVA",
      "A rule banner says which falling boxes to clear.": "Un cartel de regla indica qué cajas que caen eliminar.",
      "Click every box that matches the active rule.": "Haz clic en cada caja que cumple la regla activa.",
      "Chains arm a bomb — type its answer to defuse it.": "Las cadenas arman una bomba — escribe su respuesta para desactivarla.",
      "Boxes that touch <b>merge</b> into longer chains; a 6-operand chain arms a 10-second bomb and freezes the field. Defuse for <b style=\"color:#5cd97a\">+200</b>, or let it blow for a penalty. Score starts at <b>200</b> — hit 0 and you're out.": "Las cajas que se tocan <b>se fusionan</b> en cadenas más largas; una cadena de 6 operandos arma una bomba de 10 segundos y congela el campo. Desactívala por <b style=\"color:#5cd97a\">+200</b>, o déjala estallar para una penalización. La puntuación empieza en <b>200</b> — llega a 0 y estás fuera.",
      "Keys — <kbd>click</kbd> destroy · <kbd>0–9</kbd> type · <kbd>↵</kbd> submit · <kbd>⌫</kbd> delete · <kbd>P</kbd> pause": "Teclas — <kbd>clic</kbd> destruir · <kbd>0–9</kbd> escribir · <kbd>↵</kbd> enviar · <kbd>⌫</kbd> borrar · <kbd>P</kbd> pausa"
    }
  };
