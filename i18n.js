(function () {
  ...
  const map = {
    fr: {
      ...
      'RESCUE': 'SAUVETAGE',
      'Shoot ONLY "p" paratroopers! Save "q".': 'Tirez SEULEMENT sur les parachutistes "p" ! Sauvez "q".',
      'Shoot ONLY "q" paratroopers! Save "p".': 'Tirez SEULEMENT sur les parachutistes "q" ! Sauvez "p".',
      'Shoot ONLY "b" helicopters! Save "d".': 'Tirez SEULEMENT sur les hélicoptères "b" ! Sauvez "d".',
      'Shoot ONLY "d" helicopters! Save "b".': 'Tirez SEULEMENT sur les hélicoptères "d" ! Sauvez "b".',
      'Shoot "p" paratroopers & "b" helicopters!': 'Tirez sur les parachutistes "p" et hélicoptères "b" !',
      'Shoot "q" paratroopers & "d" helicopters!': 'Tirez sur les parachutistes "q" et hélicoptères "d" !',
      'SHOOT p': 'TIRER p',
      'SHOOT q': 'TIRER q',
    ...
    es: {
      ...
      'RESCUE': 'RESCATE',
      'Shoot ONLY "p" paratroopers! Save "q".': '¡Dispara SOLO paracaidistas "p"! Salva "q".',
      'Shoot ONLY "q" paratroopers! Save "p".': '¡Dispara SOLO paracaidistas "q"! Salva "p".',
      'Shoot ONLY "b" helicopters! Save "d".': '¡Dispara SOLO helicópteros "b"! Salva "d".',
      'Shoot ONLY "d" helicopters! Save "b".': '¡Dispara SOLO helicópteros "d"! Salva "b".',
      'Shoot "p" paratroopers & "b" helicopters!': '¡Dispara paracaidistas "p" y helicópteros "b"!',
      'Shoot "q" paratroopers & "d" helicopters!': '¡Dispara paracaidistas "q" y helicópteros "d"!',
      'SHOOT p': 'DISPARA p',
      'SHOOT q': 'DISPARA q',
